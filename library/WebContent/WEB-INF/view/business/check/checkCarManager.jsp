				...
				<div class="layui-col-md4">
					<div class="layui-card">
						...
						<div class="layui-card-body">
							图书图片:<img alt="" width="200" height="150" id="car_carimg" src="">
						</div>
					</div>
				</div>
				<div class="layui-col-md4">
				...
				function() {
					...
					$("#doSearch").click(function() {
						...
						$.post("${ctx}/check/checkRentExist.action", {
							...
							if (obj === "") {
								...
								if (obj.rentflag == 1) {
									layer.msg("您输入的出租单相关图书已经归还，无需再入库");
									$("#content").hide();
								} else {
					...
					function initCheckFormData(rentid){
						$.post("${ctx}/check/initCheckFormData.action",{rentid:rentid},function(obj){
							...
							$("#rent_returndate").html("还书时间: "+rent.returndate);	
							$("#rent_opername").html("操作员: "+rent.opername);	
							
							//图书信息
							var car=obj.car;
							$("#car_carnumber").html("图书Id: "+car.carnumber);	
							$("#car_cartype").html("图书类型: "+car.cartype);	
							$("#car_color").html("图书作者: "+car.color);	
							$("#car_price").html("购买价格: "+car.price);	
							$("#car_rentprice").html("出租价格: "+car.rentprice);	
							$("#car_deposit").html("出租押金: "+car.deposit);	
							$("#car_description").html("图书描述: "+car.description);	
