...
<body class="childrenBody">
	...
	<div id="content" style="display: none;">
		...
		<div  id="carBar" style="display: none;">
		  <a class="layui-btn layui-btn-xs layui-btn-warm" lay-event="rentCar">出租图书</a>
		  <a class="layui-btn layui-btn-xs" lay-event="viewImage">查看图书大图</a>
		</div>
	</div>
	<!-- 数据表格结束 -->
		...
		<form class="layui-form"  lay-filter="dataFrm" id="dataFrm">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="returndate"  id="returndate" placeholder="请输入还书时间"  autocomplete="off"
							class="layui-input">
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="carnumber" lay-verify="required"  readonly="readonly"  placeholder="请输入图书id" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
