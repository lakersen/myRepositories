		...
		<form class="layui-form"  lay-filter="dataFrm" id="dataFrm">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="returndate"  id="returndate" readonly="readonly" placeholder="请输入还书时间"  autocomplete="off"
							class="layui-input">
					</div>
				</div>
			</div>
			...
			//渲染数据表格
			 tableIns=table.render({
			    ...
			    ,cols: [[   //列表数据
			      ...
			      ,{field:'carnumber', title:'图书id',align:'center',width:'150'}
			      ...
			      ,{field:'returndate', title:'还书时间',align:'center',width:'180'}
