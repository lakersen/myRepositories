...
<body class="childrenBody">
		...
		<form class="layui-form layui-row layui-col-space10"  lay-filter="dataFrm" id="dataFrm">
			<div class="layui-col-md12 layui-col-xs12">
				<div class="layui-row layui-col-space10">
					<div class="layui-col-md9 layui-col-xs7">
						<div class="layui-form-item magt3">
							<label class="layui-form-label">图书id:</label>
							<div class="layui-input-block">
								<input type="text" name="carnumber" id="carnumber" class="layui-input" lay-verify="required" placeholder="请输入图书id">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">图书类型:</label>
							<div class="layui-input-block">
								<input type="text" name="cartype" class="layui-input" lay-verify="required" placeholder="请输入图书类型">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">图书作者:</label>
							<div class="layui-input-block">
								<input type="text" name="color" class="layui-input" lay-verify="required" placeholder="请输入图书作者">
							</div>
						</div>
					</div>
				...
				<div class="layui-form-item magb0">
					<label class="layui-form-label">图书描述:</label>
						<div class="layui-input-block">
							<input type="text" name="description" class="layui-input" lay-verify="required" placeholder="请输入图书描述">
						</div>
				</div>
				<div class="layui-form-item magb0">
	...
	<div id="viewCarImageDiv" style="display: none;text-align: center;">
		<img alt="图书图片" width="550" height="350" id="view_carimg">
	</div>
	<!-- 查看大图弹出的层 结束 -->
	...
	<script type="text/javascript">
	    ...
	    layui.use([ 'jquery', 'layer', 'form', 'table','upload'  ], function() {
			 ...
			 tableIns=table.render({
			    ...
			    ,cols: [[   //列表数据
			     {type: 'checkbox', fixed: 'left'}
			      ,{field:'carnumber', title:'图书id',align:'center',width:'120'}
			      ,{field:'cartype', title:'图书类型',align:'center',width:'100'}
			      ,{field:'color', title:'图书作者',align:'center',width:'120'}
			      ...
			      ,{field:'description', title:'图书描述',align:'center',width:'180'}
		   ...
		   table.on('tool(carTable)', function(obj){
			  ...
			  if(layEvent === 'del'){ //删除
				  layer.confirm('真的删除【'+data.carnumber+'】这个图书吗', function(index){
				       //向服务端发送删除指令
			...
			function deleteBatch(){
			    ...
			    layer.confirm('真的删除选中的这些图书吗', function(index){
				       //向服务端发送删除指令
